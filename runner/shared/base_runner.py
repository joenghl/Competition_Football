...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        self.eval_episode_length = self.all_args.eval_episode_length
        ...
        share_observation_space = self.envs.share_observation_space[0] if self.use_centralized_V else self.envs.observation_space
